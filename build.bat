...
set source= %rootDir%/sp/*.cpp %rootDir%/sp/video/*.cpp %rootDir%/sp/material/*.cpp %rootDir%/sp/player/*.cpp
set links=user32.lib d3d11.lib d3dcompiler.lib dxgi.lib assimp-vc140-mt.lib
